...
O projeto está configurado para Windows x64 e versão `2.1.2`.
...
O script do Inno Setup usa a saída `bin\Release\dist\2.1.2\ListForge-Installable` e gera o instalador em:
